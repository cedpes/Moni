  ...
  return (
    <MonthProvider>
      <div className="min-h-screen bg-[var(--bg-app)] pb-24">
        ...
        <nav className="fixed bottom-0 left-0 right-0 z-50 bg-[var(--header-blur-bg)] backdrop-blur-xl border-t border-[var(--border-default)]"
              ...
              return (
                <Link key={href} href={href}
                  className={cn(
                    ...
                    active ? 'text-[#a78bfa]' : 'text-[var(--text-secondary)]'
                  )}>
