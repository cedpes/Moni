...
import EnvelopesShell from '@/components/features/envelopes/EnvelopesShell'
...
export default async function EnvelopesPage() {
  ...
  return <EnvelopesShell workspaceId={workspaceId} userId={user.id} categories={categories ?? []} />
}
